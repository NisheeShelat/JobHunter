...
$time = time();
$status = 'pending';
$sql = "INSERT INTO forgotpassword (`username`, `rkey`, `time`, `status`) VALUES ('$username', '$key', '$time', '$status')";
$result = mysqli_query($link, $sql);
if(!$result){
...
$message .= "http://nishee.unaux.com/project/resetpassword.php?username=$username&key=$key";
if(mail($email, 'Reset your password', $message, 'From:'.'nisheeshelat.ttw@gmail.com')){
