...
$sql = "SELECT username FROM forgotpassword WHERE rkey='$key' AND username='$username' AND time > '$time' AND status='pending'";
...
$sql = "UPDATE forgotpassword SET status='used' WHERE rkey='$key' AND username='$username'";
$result = mysqli_query($link, $sql);
if(!$result){
