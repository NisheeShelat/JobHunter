...
$sql = "INSERT INTO users (`usertype`,`username`, `email`, `password`, `activation`) VALUES ('$usertype','$username', '$email', '$password', '$activationKey')";
$result = mysqli_query($link, $sql);
if(!$result){
...
$message .= "http://nishee.unaux.com/project/activate.php?email=" . urlencode($email) . "&key=$activationKey";
if(mail($email, 'Confirm your Registration', $message, 'From:'.'nisheeshelat.ttw@gmail.com')){
